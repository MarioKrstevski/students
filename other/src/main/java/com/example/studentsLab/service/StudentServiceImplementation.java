...
public class StudentServiceImplementation implements StudentsService {
    ...
    public void addData() {
        ...
        student.setIndex("153002");
        student.setLastName("Klimoska");
        ...
        studyProgram1.setName("PET");
        Student student1 = new Student();
        student1.setStudyProgram(studyProgram1);
        student1.setLastName("Trajkovska");
        student1.setIndex("153020");
        student1.setName("Nadica");
        ...
        student2.setName("Nenad");
        student2.setLastName("Markovic");
        student2.setStudyProgram(studyProgram2);
        student2.setIndex("151613");

        studyProgramRepo.save(studyProgram2);
